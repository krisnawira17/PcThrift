<x-header>
    ...
    <div class="flex flex-col">
        ...
        <div class="flex flex-row justify-center mb-[2vh]">
            <x-bundle-cards image="{{URL('images/ROG-G22CH.png')}}" name="ROG G22CH" price="Rp15.999.999"></x-bundle-cards>
            <x-bundle-cards image="{{URL('images/ROG-Huracan.png')}}" name="ROG Huracan" price="Rp40.999.999"></x-bundle-cards>
            <x-bundle-cards image="{{URL('images/ROG-Strix-G16CH.png')}}" name="ROG Strix G16CH" price="Rp16.999.999"></x-bundle-cards>
        </div> 
    </div>
</x-header>